...
<div class="page-content page-container" id="page-content">
    ...
    <div class="card card-bordered">
        ...
        <d iv class="ps-container ps-theme-default ps-active-y" id="chat-content"
            style="overflow-y: scroll !important; height:400px !important;">

            <div id="landlordmsg"></div>
            <div id="landlorfile"></div>
    ...
    <div class="publisher bt-1 border-light">
        ...
        <span class="publisher-btn ">
            <input type="file" id="landlordpdf_file" class="form-control file-group">
        ...
        $(document).ready(function() {
                    ...
                    $("#sendwritetext").on('keydown', function(e) {
                        if (e.keyCode == 13) {
                            ...
                            var pdfFile = $("#landlordpdf_file")[0].files[0]; // Get the selected PDF file
                                ...
                                if (data) {
                                    $.each(data, function(index, chatItem) {
                                        ...
                                        if (chatItem.send_to == 'tenant') {
                                            ...
                                            //         '<div class="media-body">' +
                                            //         '<p>' + '<a href="#" id="your_id_here"><input type="hidden" id="download_file"  value=' + chatItem.id + ' />' + 'Download Your File' + '</a>' + '</p>' +
                                            //         '</div>' +
                                            //         '</div>');
                                            //     // $("#landlordmsg").append(landlordchatBoxFile);
                                            // }

                                        }
                                        $("#landlorfile").append(landlordchatBox);
                    ...
                    const interval = setInterval(function() {
                        ...
                        $("#landlorfile").load(location.href + " #landlorfile>*", "");
                        var getpropertyslug = $("#getslug").val();
